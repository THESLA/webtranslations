...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
            ...
            'page_title' => __( 'Opciones de la Plantilla', 'webtranslations' ),
			'menu_title' => __( 'Opciones de la Plantilla', 'webtranslations' ),
	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    <div id="optionsframework" class="postbox">
				...
				<div id="optionsframework-submit">
					<input type="submit" class="button-primary" name="update" value="<?php esc_attr_e( 'Guadar Opciones', 'webtranslations' ); ?>" />
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( 'Restaurar a valores por defecto', 'webtranslations' ); ?>" onclick="return confirm( '<?php print esc_js( __( 'Click OK para restaurar. Cualquier cambio en la plantilla se perderá!', 'webtranslations' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
	...
	function save_options_notice() {
		add_settings_error( 'options-framework', 'save_options', __( 'Opciones guardadas.', 'webtranslations' ), 'updated fade' );
	}
